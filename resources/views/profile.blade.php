<html lang="en">
    <head>
        ...
        <title>Profile :: CSGON1.COM</title>
...
<div class="top-navigation">
    ...
    <div class="main-wrapper">
        ...
        <div class="box">
            <label for="trade-url">Trade Link (<a target="_blank" href="https://steamcommunity.com/id/my/tradeoffers/privacy"> Find it HERE </a>)</label>
        ...
        <div class="box">
            <label for="steam-id">Your Steam64 ID</label>
            <div class="group-input">
